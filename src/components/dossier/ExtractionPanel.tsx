      ...
      <div className="p-6">
        ...
        {doc.status === "extracting" && (
          <div className="text-center py-14 space-y-4">
            ...
            <div>
              <p className="text-[13px] text-[#999]">{t("extract.aiAnalyzing")}</p>
              <p className="text-[11px] text-[#666] mt-1">{t("extract.analyzingHint")}</p>
            </div>
          </div>
        )}
        ...
        {(doc.status === "extracted" || doc.status === "verified") && doc.fields.length === 0 && (
          <div className="text-center py-14">
            <p className="text-[13px] text-[#666]">{t("extract.noFields")}</p>
          </div>
        )}
      </div>
    </div>
